...
export default function Footer() {
    return(
        <footer className="w-full bg-red-elote flex flex-col items-center justify-center mt-10 lg:flex-row">
            ...
            <div className="w-full bg-[url(/img-mobile/bg-footer.png)] lg:bg-[url(/img-desktop/bg-footer.png)] py-20 footer bg-no-repeat bg-cover flex flex-col items-center justify-center">
